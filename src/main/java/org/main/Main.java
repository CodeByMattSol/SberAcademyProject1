...
public class Main {
        ...
        while (true) {
            ...
            if (scanner.hasNextInt()) {
                ...
                if (scanner.hasNextInt()) {
                    ...
                    scanner.nextLine();
                    System.out.println("Неверный формат ввода! Пожалуйста введите число от 1 до 3");
                    continue;
                }
            } else {
                scanner.nextLine();
            ...
            if (board[row][col] != ' ') {
                System.out.println("Клетка уже занята! Пожалуйста, выберите другую клетку");
            }
            break;
        }
    ...
    public static boolean reStart() {
        System.out.println("Хотите сыграть ещё раз? (да/y или нет/n)");
        Scanner scanner = new Scanner(System.in);

        String inp = scanner.nextLine().toLowerCase();

        if (inp.equals("да") || inp.equals("y")) {
            System.out.print("\033[H\033[2J");
            System.out.flush();
            return true;

        } else if (inp.equals("нет") || inp.equals("n")) {
